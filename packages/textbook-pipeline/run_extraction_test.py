...
# 1. Force project root into sys.path to ensure 'lib' and 'wrappers' are found as packages
PROJECT_ROOT = Path("D:/new_video_pip/textbook-pipeline").absolute()
if str(PROJECT_ROOT) not in sys.path:
    sys.path.insert(0, str(PROJECT_ROOT))

# 2. Initialize Environment (Bridge sibling repos)
try:
    from lib.environment import initialize_environment
    initialize_environment()
    print("✅ Environment bridge active. Sibling repos added to path.")
