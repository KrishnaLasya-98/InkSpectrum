...
import { EduQAScene, EduQASceneProps } from "./EduQAScene";
import { EduVideoTopicComposition } from "./EduVideoTopicComposition";
...
export const THEMES: Record<string, ThemeConfig> = {
  ...
  "sunshine-classroom": {
    ...
    monoFont: "'Nunito', system-ui, sans-serif",
    chartColors: ["#FF8C42", "#4ECDC4", "#FFD93D", "#6BCB77", "#845EC2", "#FF6B9D"],
    springConfig: { damping: 14, stiffness: 60, mass: 1.2 },
    transitionDuration: 0.6,
    captionHighlightColor: "#FF6B9D",
    captionBackgroundColor: "rgba(255, 253, 240, 0.9)",
  },
};
          ...
          cards: [
            {
              ...
              choices: ["a) water", "b) land", "c) sky", "d) trees"],
              correct_index: 0,
